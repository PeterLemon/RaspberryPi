; Raspberry Pi 'Bare Metal' Tags Demo by krom (Peter Lemon):
...
imm32 r1,((SCREEN_X * 8) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,8
add r0,r10,r1
PrintText VCText, 10

imm32 r1,((SCREEN_X * 16) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,16
add r0,r10,r1
PrintTAGValueLE VCFirmwareRevisionText, 19, VCFirmwareRevisionValue, 4


imm32 r1,((SCREEN_X * 32) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,32
add r0,r10,r1
PrintText HWText, 9

imm32 r1,((SCREEN_X * 40) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,40
add r0,r10,r1
PrintTAGValueLE HWBoardModelText, 19, HWBoardModelValue, 4

imm32 r1,((SCREEN_X * 48) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,48
add r0,r10,r1
PrintTAGValueLE HWBoardRevisionText, 19, HWBoardRevisionValue, 4

imm32 r1,((SCREEN_X * 56) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,56
add r0,r10,r1
PrintTAGValueBE HWBoardMACAddressText, 19, HWBoardMACAddressValue, 6

imm32 r1,((SCREEN_X * 64) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,64
add r0,r10,r1
PrintTAGValueLE HWBoardSerialText, 19, HWBoardSerialValue, 8

imm32 r1,((SCREEN_X * 72) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,72
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 80) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,80
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 96) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,96
add r0,r10,r1
PrintText SRMText, 27

imm32 r1,((SCREEN_X * 104) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,104
add r0,r10,r1
PrintTAGValueLE SRMDMAChannelsText, 14, SRMDMAChannelsValue, 4


imm32 r1,((SCREEN_X * 120) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,120
add r0,r10,r1
PrintText PWRText, 6

imm32 r1,((SCREEN_X * 128) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,128
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 136) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,136
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 144) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,144
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 152) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,152
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 160) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,160
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 168) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,168
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 176) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,176
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 184) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,184
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 192) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,192
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 208) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,208
add r0,r10,r1
PrintText CLKText, 7

imm32 r1,((SCREEN_X * 216) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,216
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 224) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,224
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 232) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,232
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 240) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,240
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 248) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,248
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 256) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,256
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 264) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,264
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 272) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,272
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 280) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,280
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 288) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,288
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 296) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,296
add r0,r10,r1
PrintTAGValueLE CLKTurboText, 7, CLKTurboValue, 4


imm32 r1,((SCREEN_X * 312) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,312
add r0,r10,r1
PrintText VLTText, 8

imm32 r1,((SCREEN_X * 320) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,320
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 328) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,328
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 336) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,336
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 344) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,344
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 352) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,352
add r0,r10,r1
PrintTAGValueLE VLTTemperatureText, 13, VLTTemperatureValue, 4
PrintTAGValueLE MaxText, 6, VLTTemperatureMaxValue, 4


imm32 r1,((SCREEN_X * 368) * (BITS_PER_PIXEL / 8)) + (8 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 8,368
add r0,r10,r1
PrintText FBText, 13

imm32 r1,((SCREEN_X * 376) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,376
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 384) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,384
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 392) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,392
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 400) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,400
add r0,r10,r1
...
imm32 r1,((SCREEN_X * 408) * (BITS_PER_PIXEL / 8)) + (16 * (BITS_PER_PIXEL / 8)) ; Place text at XY Position 16,408
add r0,r10,r1

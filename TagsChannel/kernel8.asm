; Raspberry Pi 3 'Bare Metal' Multiple Tags Demo by krom (Peter Lemon):
...
mov w1,16 + (SCREEN_X * 16)
add w0,w10,w1 ; Place Text At XY Position 16,16
...
add w0,w10,w1 ; Place Text At XY Position 16,64
...
mov w1,160 ; 16 + (SCREEN_X * 160)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,160
...
mov w1,216 ; 16 + (SCREEN_X * 216)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,216
...
mov w1,224 ; 16 + (SCREEN_X * 224)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,224
...
mov w1,232 ; 16 + (SCREEN_X * 232)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,232
...
mov w1,240 ; 16 + (SCREEN_X * 240)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,240
...
mov w1,248 ; 16 + (SCREEN_X * 248)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,248
...
mov w1,256 ; 16 + (SCREEN_X * 256)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,256
...
mov w1,264 ; 16 + (SCREEN_X * 264)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,264
...
mov w1,272 ; 16 + (SCREEN_X * 272)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,272
...
mov w1,280 ; 16 + (SCREEN_X * 280)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,280
...
mov w1,288 ; 16 + (SCREEN_X * 288)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,288
...
mov w1,296 ; 16 + (SCREEN_X * 296)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,296
...
mov w1,320 ; 16 + (SCREEN_X * 320)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,320
...
mov w1,328 ; 16 + (SCREEN_X * 328)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,328
...
mov w1,336 ; 16 + (SCREEN_X * 336)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,336
...
mov w1,344 ; 16 + (SCREEN_X * 344)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,344
...
mov w1,352 ; 16 + (SCREEN_X * 352)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,352
PrintTAGValueLE VLTTemperatureText, 13, VLTTemperatureValue, 4
PrintTAGValueLE MaxText, 6, VLTTemperatureMaxValue, 4


mov w1,368 ; 8 + (SCREEN_X * 368)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,8
add w0,w10,w1 ; Place Text At XY Position 8,368
PrintText FBText, 13

mov w1,376 ; 16 + (SCREEN_X * 376)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,376
...
mov w1,384 ; 16 + (SCREEN_X * 384)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,384
...
mov w1,400 ; 16 + (SCREEN_X * 400)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,400
...
mov w1,408 ; 16 + (SCREEN_X * 408)
mov w2,SCREEN_X
mul w1,w1,w2
add w1,w1,16
add w0,w10,w1 ; Place Text At XY Position 16,408

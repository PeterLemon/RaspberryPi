; Raspberry Pi 'Bare Metal' Input SNES Mouse Text Demo by krom (Peter Lemon):
...
tst r1,MOUSE_DIRX ; Store Mouse X Position
addeq r2,1
subne r2,1
...
tst r1,MOUSE_DIRY ; Store Mouse Y Position
addeq r2,1
subne r2,1

; Raspberry Pi 'Bare Metal' Input SNES GamePad GFX Demo by krom (Peter Lemon):
...
adr r0,BG_STRUCT
imm32 r1,PERIPHERAL_BASE + DMA0_BASE + DMA0_CONBLK_AD
str r0,[r1]

; Set Start Bit
mov r0,DMA_ACTIVE
imm32 r1,PERIPHERAL_BASE + DMA0_BASE + DMA0_CS
str r0,[r1]

;;;;;;;;;;;;;;;;;;;;
;; Initialize Pad ;;
;;;;;;;;;;;;;;;;;;;;
; Set GPIO 10 & 11 (Pad Clock & Latch) Function To Output
...
;;;;;;;;;;;;;;;;
UpdatePad:
  imm32 r0,PERIPHERAL_BASE + GPIO_BASE ; Set GPIO 11 (Pad Latch) Output State To HIGH
  mov r1,GPIO_11
  str r1,[r0,GPIO_GPSET0]
  Delay 3

  mov r1,GPIO_11 ; Set GPIO 11 (Pad Latch) Output State To LOW
  str r1,[r0,GPIO_GPCLR0]
  Delay 3

  mov r1,0  ; R1 = Pad Data
  mov r2,15 ; R2 = Pad Data Count
  LoopPadData:
    ldr r3,[r0,GPIO_GPLEV0] ; Get GPIO 4 (Pad Data) Level
    tst r3,GPIO_4
    moveq r3,1 ; GPIO 4 (Pad Data) Level LOW
    orreq r1,r3,lsl r2

    mov r3,GPIO_10 ; Set GPIO 10 (Pad Clock) Output State To HIGH
    str r3,[r0,GPIO_GPSET0]
    Delay 3

    mov r3,GPIO_10 ; Set GPIO 10 (Pad Clock) Output State To LOW
    str r3,[r0,GPIO_GPCLR0]
    Delay 3

    subs r2,1
    bge LoopPadData ; Loop 16bit Data

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; R1 Now Contains Pad Data ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

; Raspberry Pi 2 'Bare Metal' V3D Fill Color VG Coordinate Array Triangle Strip Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  VG_Coordinate_Array_Primitives Primitives_Type_Triangle_Strip, 4, BUS_ADDRESSES_l2CACHE_DISABLED + VERTEX_DATA ; VG Coordinate Array Primitives (Only For Use In VG Shader Mode)

; Raspberry Pi 3 'Bare Metal' V3D Fill Color VG Coordinate Array RHT Strip Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  RHT_X_Boundary 32 * 16 ; RHT X Boundary
  ...
  VG_Coordinate_Array_Primitives Primitives_Type_RHT_Strip, 3, BUS_ADDRESSES_l2CACHE_DISABLED + VERTEX_DATA ; VG Coordinate Array Primitives (Only For Use In VG Shader Mode)
...
VERTEX_DATA:
  ...
  dh 240 * 16 ; Y In 12.4 Fixed Point

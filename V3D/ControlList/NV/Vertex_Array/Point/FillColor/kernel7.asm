; Raspberry Pi 2 'Bare Metal' V3D Fill Color NV Vertex Array Point Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Vertex_Array_Primitives Mode_Points, 2, 0 ; Vertex Array Primitives (OpenGL)
...
NV_SHADER_STATE_RECORD:
  ...
  db 4 * 4 ; Shaded Vertex Data Stride

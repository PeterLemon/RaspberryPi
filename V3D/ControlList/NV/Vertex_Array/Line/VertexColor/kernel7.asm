; Raspberry Pi 2 'Bare Metal' V3D Vertex Color NV Vertex Array Line Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Vertex_Array_Primitives Mode_Lines, 2, 0 ; Vertex Array Primitives (OpenGL)

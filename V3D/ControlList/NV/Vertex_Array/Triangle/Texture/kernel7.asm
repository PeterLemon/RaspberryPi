; Raspberry Pi 2 'Bare Metal' V3D Texture NV Vertex Array Triangle Control List Demo by krom (Peter Lemon):
...
NV_SHADER_STATE_RECORD:
  ...
  dw BUS_ADDRESSES_l2CACHE_DISABLED + FRAGMENT_SHADER_UNIFORMS ; Fragment Shader Uniforms Address

; Raspberry Pi 2 'Bare Metal' V3D Vertex Color NV Vertex Array Line Loop Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Vertex_Array_Primitives Mode_Line_Loop, 3, 0 ; Vertex Array Primitives (OpenGL)

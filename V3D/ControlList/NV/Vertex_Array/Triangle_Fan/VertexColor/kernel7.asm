; Raspberry Pi 2 'Bare Metal' V3D Vertex Color NV Vertex Array Triangle Fan Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Vertex_Array_Primitives Mode_Triangle_Fan, 4, 0 ; Vertex Array Primitives (OpenGL)

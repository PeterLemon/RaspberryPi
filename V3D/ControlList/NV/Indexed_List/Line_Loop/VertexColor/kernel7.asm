; Raspberry Pi 2 'Bare Metal' V3D Vertex Color NV Indexed List Line Loop Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Indexed_Primitive_List Mode_Line_Loop + Index_Type_8, 3, VERTEX_LIST, 2 ; Indexed Primitive List (OpenGL)

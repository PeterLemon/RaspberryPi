; Raspberry Pi 2 'Bare Metal' V3D Vertex Color NV Indexed List Triangle Strip Control List Demo by krom (Peter Lemon):
...
CONTROL_LIST_BIN_STRUCT: ; Control List Of Concatenated Control Records & Data Structure (Binning Mode Thread 0)
  ...
  Indexed_Primitive_List Mode_Triangle_Strip + Index_Type_8, 4, VERTEX_LIST, 3 ; Indexed Primitive List (OpenGL)

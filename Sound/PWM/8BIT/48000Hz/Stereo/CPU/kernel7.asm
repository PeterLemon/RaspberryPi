; Raspberry Pi 2 'Bare Metal' Sound 8Bit Stereo 48000Hz CPU Demo by krom (Peter Lemon):
...
imm32 r1,$C8 ; Range = 8bit 48000Hz Stereo
str r1,[r0,PWM_RNG1]
str r1,[r0,PWM_RNG2]
...
SND_Sample: ; 8bit 48000Hz Unsigned Stereo Sound Sample
  file 'Sample.bin'
  SND_SampleEOF:
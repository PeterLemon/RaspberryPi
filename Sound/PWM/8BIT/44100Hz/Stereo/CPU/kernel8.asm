; Raspberry Pi 3 'Bare Metal' Sound 8Bit Stereo 44100Hz CPU Demo by krom (Peter Lemon):
...
orr w0,w0,w1
mov w1,$DA ; Range = 8bit 44100Hz Stereo
str w1,[x0,PWM_RNG1]
str w1,[x0,PWM_RNG2]
...
Loop:
  ...
  orr w2,w2,w3
  FIFO_Write:
    ldrb w3,[x1],1	 ; Write 1 Byte To FIFO (Channel 1)
    str w3,[x0,PWM_FIF1] ; FIFO Address
    ldrb w3,[x1],1	 ; Write 1 Byte To FIFO (Channel 2)
    str w3,[x0,PWM_FIF1] ; FIFO Address
    FIFO_Wait:
      ldr w3,[x0,PWM_STA]

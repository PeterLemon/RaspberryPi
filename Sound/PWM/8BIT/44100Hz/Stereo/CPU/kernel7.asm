; Raspberry Pi 2 'Bare Metal' Sound 8Bit Stereo 44100Hz CPU Demo by krom (Peter Lemon):
...
imm32 r1,$DA ; Range = 8bit 44100Hz Stereo
str r1,[r0,PWM_RNG1]
str r1,[r0,PWM_RNG2]
...
Loop:
  ...
  FIFO_Write:
    ldrb r3,[r1],1	 ; Write 1 Byte To FIFO (Channel 1)
    str r3,[r0,PWM_FIF1] ; FIFO Address
    ldrb r3,[r1],1	 ; Write 1 Byte To FIFO (Channel 2)
    str r3,[r0,PWM_FIF1] ; FIFO Address
    FIFO_Wait:
      ldr r3,[r0,PWM_STA]
...
SND_Sample: ; 8bit 44100Hz Unsigned Stereo Sound Sample
  file 'Sample.bin'
  SND_SampleEOF:
; Raspberry Pi 2 'Bare Metal' Sound 12Bit Mono 44100Hz CPU Demo by krom (Peter Lemon):
...
imm32 r1,$2C48 ; Range = 12bit 44100Hz Mono
str r1,[r0,PWM_RNG1]
str r1,[r0,PWM_RNG2]
...
Loop:
  ...
  FIFO_Write:
    ldrh r3,[r1],2 ; Write 2 Bytes To FIFO
...
SND_Sample: ; 12bit 44100Hz Unsigned Little Endian Mono Sound Sample
  file 'Sample.bin'
  SND_SampleEOF:
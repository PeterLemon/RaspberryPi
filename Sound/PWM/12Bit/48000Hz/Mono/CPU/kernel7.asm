; Raspberry Pi 2 'Bare Metal' Sound 12Bit Mono 48000Hz CPU Demo by krom (Peter Lemon):
...
imm32 r1,$28A0 ; Range = 12bit 48000Hz Mono
str r1,[r0,PWM_RNG1]
str r1,[r0,PWM_RNG2]
...
SND_Sample: ; 12bit 48000Hz Unsigned Little Endian Mono Sound Sample
  file 'Sample.bin'
  SND_SampleEOF:
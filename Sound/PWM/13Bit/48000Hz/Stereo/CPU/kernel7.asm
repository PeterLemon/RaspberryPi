; Raspberry Pi 2 'Bare Metal' Sound 13Bit Stereo 48000Hz CPU Demo by krom (Peter Lemon):
...
imm32 r1,$1450 ; Range = 13bit 48000Hz Stereo
str r1,[r0,PWM_RNG1]
str r1,[r0,PWM_RNG2]
...
SND_Sample: ; 16bit 48000Hz Unsigned Little Endian Stereo Sample
  file 'Sample.bin'
  SND_SampleEOF:
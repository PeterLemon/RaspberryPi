...
sub r1,r6 ; R1 -= CPU ID * Pixel Byte Size
add r0,r6 ; R0 += CPU ID * Pixel Byte Size
...
Refresh:
  ...
  LoopY:
	...
	str r4,[r2],4 * 4  ; Store Pixel Colour To Frame Buffer (Top)
	str r4,[r3],-4 * 4 ; Store Pixel Colour To Frame Buffer (Bottom)

	fsubs s0,s8 ; Decrement X% (-4)
	fcmpzs s0
	fmstat
	bgt LoopX ; IF (X% > 0) LoopX

...
; 4. Change Julia Settings and Redraw to Animate
...
Refresh:
  ...
  LoopY:
	...
	str r4,[r2],4  ; Store Pixel Colour into the Frame Buffer (Top)
	str r4,[r3],-4 ; Store Pixel Colour into the Frame Buffer (Bottom)
